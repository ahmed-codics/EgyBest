        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          ...
          >
            <div className="relative">
              <img
                src="https://images.unsplash.com/photo-1488085061387-422e29b40080?q=80&w=1031&auto=format&fit=crop&ixlib=rb-4.1.0"
                alt="مستودعات EgyBest للشحن"
                className="w-full h-96 object-cover rounded-2xl shadow-xl"
              />

              <motion.img
                src="https://images.unsplash.com/photo-1566576721346-d4a3b4eaeb55?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0"
          ...
          >
            ...
            <p className="text-xl text-blue-600 mb-6 leading-relaxed tajawal-regular">
              <span className="text-blue-800 font-bold">EgyBest</span> هي شركة
              شحن رائدة في مصر، نقدم حلول شحن متكاملة ومبتكرة منذ عام 2010. نحن
              نفتخر بتقديم خدمات شحن عالية الجودة تلبي احتياجات عملائنا في جميع
              أنحاء العالم.
            </p>
            <p className="text-lg text-blue-600 mb-8 leading-relaxed tajawal-regular">
              برؤيتنا الواضحة وتركيزنا على التميز، استطعنا بناء سمعة طيبة كواحد
              من أفضل مقدمي خدمات الشحن في المنطقة، مع التزامنا الدائم بالجودة
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              {stats.map((stat, index) => (
                <motion.div
                  ...
                  className="text-center p-4 bg-white rounded-xl shadow-md border border-blue-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
                  <div className="text-3xl font-bold text-blue-800 mb-2">
                    {stat.number}
                  </div>
                  <div className="text-blue-600 tajawal-medium">
                    {stat.label}
                  </div>
                </motion.div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <motion.div
                key={index}
                whileHover={{ scale: 1.05 }}
                className="bg-white p-6 rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300 border border-blue-100 text-center"
              >
                <div className="text-4xl mb-4 text-blue-600">
                  {feature.icon}
                </div>
                <h4 className="text-xl font-bold text-blue-800 mb-3 tajawal-bold">
                  {feature.title}
                </h4>
                <p className="text-blue-600 tajawal-regular">
                  {feature.description}
                </p>
              </motion.div>
            ))}
